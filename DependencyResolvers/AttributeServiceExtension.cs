...
namespace DynamicStrategyPattern.DependencyResolvers
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Register the services marked the attribute
        /// </summary>
        /// <returns></returns>
        public static IServiceCollection RegisterAttributeServices(this IServiceCollection serviceCollection)
        {
            var assembly = typeof(Program).Assembly;// Assembly.GetExecutingAssembly(assembliesToBeScanned);
